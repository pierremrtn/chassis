...
- [can't be done] introduce private ReadQuery / WatchQuery query type to prevent ReadHandler with ReadWatchQuery
...
Pattern: WatchQuery[Resource]By[Criteria]Query
    ...
    Verb: WatchQuery is the most intuitive verb. Observe is a good alternative.
...
Query Handler Examples:
    ...
    Handles WatchQueryAllActiveTicketsQuery -> WatchQueryAllActiveTicketsQueryHandler
